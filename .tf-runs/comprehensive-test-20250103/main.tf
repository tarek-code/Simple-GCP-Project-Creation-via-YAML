...
module "secret_2" {
  ...
  replication = {"user_managed": [{"location": "us-central1"}, {"location": "us-west1"}]}
  additional_versions = []
}
...
module "secret_3" {
  ...
  replication = null
  additional_versions = ["old-jwt-secret-abc"]
}
